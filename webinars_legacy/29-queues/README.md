...
# Kafka: внутреннее устройство

.main-image[![otus main](img/kafka-topic-partitions.png)]

---

# Kafka: репликация

.main-image[![otus main](img/apache-kafka-replication.png)]

---

.main-image[![otus main](img/kafka-use-cases.png)]

---

# Kafka: визуализатор работы
